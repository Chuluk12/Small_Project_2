						...
						<Row>
							...
							<Col sm={2}>
								<Button
									...
									className="p-2"
								>
									<PencilSquare size={23} color="royalblue" />
								</Button>
								<Button
									variant="link"
									...
									className="p-2"
								>
									<ArrowsFullscreen size={20} color="royalblue" />
								</Button>
								<Button
									variant="link"
...
// mengubah store menjadi props
const mapStateToProps = state => ({
	todos: state.todos.todos,
	todo: state.todos.todo,
});

// merubah action menjadi props
const mapDispatchToProps = dispatch => ({
	getTodo: () => dispatch(getTodo()),
});

const ListTodoPage = connect(mapStateToProps, mapDispatchToProps)(Component);
